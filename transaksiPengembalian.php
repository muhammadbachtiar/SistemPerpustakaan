...
$title = 'Sistem Peprustakaan Digital - Transaksi Pengembalian';
...
$dataPengembalian = select("SELECT laporantranskasi.*, dataanggota.idAnggota as anggotaID, dataanggota.nama, databuku.judul 
...
<div class="container-fluid">
     ...
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-2 text-gray-800">Halaman Trantsaksi Pengembalian</h1>
            <p class="mb-4">Daftar data transaksi pengembalian buku pada Sistem Perpustakaan Digital.</p>
        </div>
        <div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dataPengembalian as $pengembalian) : ?>
                            <tr>
                                ...
                                <td><?= $pengembalian['anggotaID']; ?></td>
                                <td><?= $pengembalian['nama']; ?></td>
                                <td><?= $pengembalian['judul']; ?></td>
                                <td><?= $pengembalian['waktuPengembalian']; ?></td>
                                <td>
                                <div>
                                    <a target="_blank" href="cetakNotaPengembalian.php?id=<?= $pengembalian['id_transaksi']; ?>" class="btn btn-info btn-icon-split btn-sm">
                                        <span class="icon">
                                            <i class="fas fa-print"></i>
                                        </span>
                                        <span class="text">Nota Pengembalian</span>
                                    </a>
                                </div>
                                </td>
                            </tr>
...
<div class="modal fade" id="kembaliBuku<?= $pengembalian['id_transaksi']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    Setelah klik tombol "Kembalikan"  data transaksi pengembalian <?= $pengembalian['idTransaksi']; ?> akan dimasukan ke transaksi pengembalian
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success" type="button" data-dismiss="modal">Cancel</button>
                    <form class="user" action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" type="number" id="id_transaksi" name="id_transaksi" value="<?php echo $pengembalian['id_transaksi']; ?>" required readonly>
